...
from .patient_manager_component import PatientManagerComponent
...
class CognitiveScreen:
    ...
    def __init__(self, arduino_manager):
        ...
        # Colores theme
        self.colors = {"background": (20, 25, 40), "text": (255, 255, 255)}
        ...
        # Managers cognitivos (se inicializan en initialize())
    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            # Inicializar managers cognitivos
            ...
            self.patient_manager = PatientManagerComponent("piano_simon")
            self.session_list = SessionListComponent()
            self.button_panel = ButtonPanelComponent(
                self.visual_analyzer, self.session_list, self._on_exit
            )
            ...
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    ...
                    if event.key == pygame.K_ESCAPE:
                        self.running = False
                    # Dar prioridad al input de pacientes
                    elif not self.patient_manager.handle_keydown(
                        event, self.message_manager
                    ):
    ...
    def _handle_mouse_click(self, event):
        ...
        # Verificar gestión de pacientes primero
        self.patient_manager.handle_click(mouse_pos, self.message_manager)
    ...
    def _draw(self):
        ...
        self.patient_manager.draw(self.screen, pygame.mouse.get_pos())
