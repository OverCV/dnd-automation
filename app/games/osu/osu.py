...
class OsuGame(BaseGame):
    ...
    def start_game(self) -> bool:
        ...
        try:
            ...
            print(
                "[DEBUG OsuGame] Llamando a visual_manager.mostrar_animacion_inicio..."
            )
            ...
            print(
                f"[DEBUG OsuGame] game_state establecido a: {self.game_logic.game_state}"
            )
    ...
    def _main_game_loop(self):
        ...
        if not self.visual_manager.initialized:
            print(
                "[DEBUG OsuGame _main_game_loop] ERROR: VisualManager no está inicializado al entrar al loop!"
            )
