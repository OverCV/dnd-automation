...
byte rowPins[ROW_COUNT] = {6, 5, 4};    // ROW0, ROW1, ROW2 del keypad
byte colPins[COL_COUNT] = {3, 2};       // COL0, COL2 del keypad
...
const byte LED_4 = 9;   // Botón 4
const byte LED_7 = 10;  // Botón 7
const byte LED_3 = 11;  // Botón 3
const byte LED_6 = 12;  // Botón 6
const byte LED_9 = 13;  // Botón 9
