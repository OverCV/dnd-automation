...
class ConnectionFrame:
    ...
    def __init__(self, parent, arduino: ArduinoManager, game_controller: GameController):
        self.arduino = arduino
        self.game_controller = game_controller
        conn_frame = tk.LabelFrame(
            parent, text="🔌 Conexión Arduino",
    ...
    def _create_connection_row1(self, conn_frame):
        ...
        tk.Label(conn_row1, text="Puerto:", bg="#34495E", fg="white",
                font=("Arial", 10)).pack(side=tk.LEFT, padx=(0, 5))

        self.port_var = tk.StringVar()
        self.port_combo = ttk.Combobox(conn_row1, textvariable=self.port_var,
